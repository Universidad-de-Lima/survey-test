...
9. **Tests JS**: suite JS 146 tests TestFramework (94 base + 38 de `test-upload-validator.js` + 14 de `test-portal-data.js`) + 33 tests jsdom = 179 tests (fuente canonica: `tests/README.md`).
