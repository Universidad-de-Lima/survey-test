...
// ---------- Phase definitions ----------
let PORTAL_PHASES = [
  { id: "1.0", order: 0, name: "Estudiantes Pregrado", fullName: "Estudiantes Pregrado",
    role: "Experiencia de pregrado", artifact: "", artifactLabel: "", predecessor: null, successor: "1.1",
    icon: "book-open" },
  { id: "1.1", order: 1, name: "Estudiantes Posgrado", fullName: "Estudiantes Posgrado",
    role: "Experiencia de posgrado", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.0", successor: "1.2",
    icon: "book-open" },
  { id: "1.2", order: 2, name: "Graduados Pregrado", fullName: "Graduados Pregrado",
    role: "Vinculación con graduados", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.1", successor: "1.3",
    icon: "graduation-cap" },
  { id: "1.3", order: 3, name: "Egresados Pregrado", fullName: "Egresados Pregrado",
    role: "Inserción laboral", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.2", successor: "1.4",
    icon: "graduation-cap" },
  { id: "1.4", order: 4, name: "Egresados Posgrado", fullName: "Egresados Posgrado",
    role: "Seguimiento de egresados", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.3", successor: "1.5",
    icon: "graduation-cap" },
  { id: "1.5", order: 5, name: "Docentes Pregrado", fullName: "Docentes Pregrado",
    role: "Experiencia del profesorado", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.4", successor: "1.6",
    icon: "marker" },
  { id: "1.6", order: 6, name: "Docentes Posgrado", fullName: "Docentes Posgrado",
    role: "Clima académico", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.5", successor: "1.7",
    icon: "marker" },
  { id: "1.7", order: 7, name: "Personal No Docente", fullName: "Personal No Docente",
    role: "Satisfacción del personal", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.6", successor: "1.8",
    icon: "users" },
  { id: "1.8", order: 8, name: "Empleadores", fullName: "Empleadores",
    role: "Vinculación con empleadores", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.7", successor: "1.9",
    icon: "briefcase" },
  { id: "1.9", order: 9, name: "Preguntas", fullName: "Preguntas (IA)",
    role: "Asistente IA", artifact: "AUDIT-REVIEW.md|AUDIT-REPORT-v2.md",
    artifactLabel: "AUDIT-REVIEW.md + AUDIT-REPORT-v2.md", predecessor: "1.8", successor: null,
        ...
        '<div class="artifact-header-row">' +
          '<div style="min-width:0;">' +
            ...
            '<h1 class="artifact-title">' +
              '<span style="color: var(--primary);">' + svg(phase.icon, 24) + '</span>' +
              phase.fullName +
            '</h1>' +
          '</div>' +
          fileTabsHtml +
...
function renderUnderConstruction() {
  return '<div class="state-box" style="display:flex;align-items:center;justify-content:center;">' +
